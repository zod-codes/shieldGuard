...
export function ContactOptionsModal({ isOpen, onClose }: ContactOptionsModalProps) {
  ...
  const handleTelegramClick = () => {
    window.open('https://t.me/ShieldGuard_Transport_Services', '_blank');
    onClose();
  };
      ...
      <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full p-6 relative">
        ...
        <div className="space-y-3">
          ...
          <button
            ...
            className="w-full flex items-center justify-center space-x-3 px-6 py-4 bg-[#25D366] hover:bg-[#22c55e] text-white rounded-xl transition-colors shadow-sm hover:shadow-md"
          >
            <svg
              viewBox="0 0 24 24"
          ...
          <button
            ...
            className="w-full flex items-center justify-center space-x-3 px-6 py-4 bg-[#0088cc] hover:bg-[#0077b5] text-white rounded-xl transition-colors shadow-sm hover:shadow-md"
          >
            <svg
              viewBox="0 0 24 24"
              className="w-6 h-6 fill-current"
